...
import type { FinanceAgentResponse } from '../types.js';
 ...
 */
export function createOpenAILLMAdapter(options: OpenAILLMAdapterOptions = {}): LLMAdapter {
  ...
  return {
    async complete(params) {
      ...
      const parsed = JSON.parse(cleaned) as FinanceAgentResponse;
